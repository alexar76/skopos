...
from .traffic import BOT_UA_SQL_LIKES, SERVICE_PATH_PATTERN, SERVICE_UA_PATTERN
...
def filters_sql(
    ...
    *,
    ...
    if filters.hide_bots:
        # Drop library-flagged bots + heuristic UA/browser matches (Applebot etc.
        # often land as ua_is_bot=0 because user_agents misses them).
        ua_parts = " OR ".join(
        ...
        clauses.append(
            f"NOT (ua_is_bot = 1 OR ({ua_parts}) OR ({br_parts}))"
        )
