...
def _days_ago(n: int) -> str:
    """A timestamp relative to today.

    These used to be fixed calendar dates, which meant the fixtures drifted out
    of the queries' own lookback windows as time passed and the suite began
...
def test_scan_history_roundtrip(tmp_path):
    ...
    snap2_dict["scanned_at_utc"] = _days_ago(2)
