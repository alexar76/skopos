...
def test_observability_locale_title():
    assert t("observability.title", "en") == "Observability"
    assert t("app.observability", "ru") == "Наблюдаемость"
    assert "Observabilité" in t("app.observability", "fr")
    assert t("app.observability", "zh") == "可观测性"
